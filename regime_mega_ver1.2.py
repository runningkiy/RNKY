# -*- coding: utf-8 -*-
"""
Created on Fri Mar 20 19:37:03 2020
...
for r in ['data_centers','diversified','health_care','industrial',
    ...
    dfmegastd.loc[r,regimelist[0]] = HHH.std()[0]
    dfmegastd.loc[r,regimelist[1]] = HHL.std()[0]
    dfmegastd.loc[r,regimelist[2]] = HLH.std()[0]
    dfmegastd.loc[r,regimelist[3]] = HLL.std()[0]
    dfmegastd.loc[r,regimelist[4]] = LHH.std()[0]
    dfmegastd.loc[r,regimelist[5]] = LHL.std()[0]
    dfmegastd.loc[r,regimelist[6]] = LLH.std()[0]
    dfmegastd.loc[r,regimelist[7]] = LLL.std()[0]
...
megawriter=xlwt.Workbook(encoding='utf-8') 
...
megawriter.save(r'E:\Varde\Python\megatest.xlsx')
